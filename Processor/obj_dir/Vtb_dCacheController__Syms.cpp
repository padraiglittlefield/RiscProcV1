    ...
    , TOP__tb_dCacheController__DOT__arbiter_if{this, Verilated::catName(namep, "tb_dCacheController.arbiter_if")}
{
    ...
    // Setup scopes
    __Vscope_tb_dCacheController.configure(this, name(), "tb_dCacheController", "tb_dCacheController", -9, VerilatedScope::SCOPE_OTHER);
    ...
    __Vscope_tb_dCacheController__read_miss_and_repair__unnamedblk1.configure(this, name(), "tb_dCacheController.read_miss_and_repair.unnamedblk1", "unnamedblk1", -9, VerilatedScope::SCOPE_OTHER);
}
