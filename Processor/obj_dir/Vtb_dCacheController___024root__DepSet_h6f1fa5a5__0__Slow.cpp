...
VL_ATTR_COLD void Vtb_dCacheController___024root___ctor_var_reset(Vtb_dCacheController___024root* vlSelf) {
    ...
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__raddr_reg = VL_RAND_RESET_I(32);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__waddr_reg = VL_RAND_RESET_I(32);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__raddr_valid_reg = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__read_miss_repair = VL_RAND_RESET_I(1);
