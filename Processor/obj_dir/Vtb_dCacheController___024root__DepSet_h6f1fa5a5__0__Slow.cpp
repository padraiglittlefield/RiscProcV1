...
VL_ATTR_COLD void Vtb_dCacheController___024root___eval_stl(Vtb_dCacheController___024root* vlSelf) {
    ...
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vtb_dCacheController___024root___stl_sequent__TOP__0(vlSelf);
...
VL_ATTR_COLD void Vtb_dCacheController___024root___ctor_var_reset(Vtb_dCacheController___024root* vlSelf) {
    ...
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__read_miss_and_repair__Vstatic__unnamedblk1__DOT__repaired_block);
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__read_hit__Vstatic__unnamedblk2__DOT__repaired_block);
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__write_hit__Vstatic__unnamedblk3__DOT__new_block);
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__write_miss__Vstatic__unnamedblk4__DOT__new_block);
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__rdata_block);
    ...
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__raddr_reg2 = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__raddr_valid_reg2 = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__wdata_reg0);
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__wdata_reg1);
    VL_RAND_RESET_W(128, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__wmask_reg0);
    VL_RAND_RESET_W(128, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__wmask_reg1);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__waddr_reg0 = VL_RAND_RESET_I(32);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__waddr_reg1 = VL_RAND_RESET_I(32);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__waddr_valid_reg0 = VL_RAND_RESET_I(1);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__waddr_valid_reg1 = VL_RAND_RESET_I(1);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__rdata_valid = VL_RAND_RESET_I(1);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__missed_addr = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(128, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__wmask_i);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__waddr_i = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__wdata_i);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__wblock_metadata_i = VL_RAND_RESET_I(19);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__read_tag = VL_RAND_RESET_I(1);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT____Vcellinp__tag_store0__csb1 = VL_RAND_RESET_I(1);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__repairing = VL_RAND_RESET_I(1);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__repairing_next = VL_RAND_RESET_I(1);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__repairing_prev = VL_RAND_RESET_I(1);
    ...
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__data_store__DOT__mem[__Vi0]);
    }
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__data_store__DOT__csb0_reg = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(128, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__data_store__DOT__wmask0_reg);
    vlSelf->tb_dCacheController__DOT__controller_dut__DOT__data_store__DOT__addr0_reg = VL_RAND_RESET_I(8);
    VL_RAND_RESET_W(1024, vlSelf->tb_dCacheController__DOT__controller_dut__DOT__data_store__DOT__din0_reg);
    ...
    VL_RAND_RESET_W(1024, vlSelf->__Vintraval_h9c92da6c__0);
    ...
    VL_RAND_RESET_W(1024, vlSelf->__Vdlyvval__tb_dCacheController__DOT__controller_dut__DOT__rdata_block__v0);
