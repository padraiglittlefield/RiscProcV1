...
class alignas(VL_CACHE_LINE_BYTES) Vtb_dCacheController___024root final : public VerilatedModule {
  public:
    ...
    VlWide<8>/*255:0*/ tb_dCacheController__DOT__read_miss_and_repair__Vstatic__unnamedblk1__DOT__repaired_block;
    ...
    IData/*31:0*/ tb_dCacheController__DOT__controller_dut__DOT__data_store__DOT__wmask0_reg;
    VlWide<8>/*255:0*/ tb_dCacheController__DOT__controller_dut__DOT__data_store__DOT__din0_reg;
    ...
    VlWide<8>/*255:0*/ __Vintraval_h1d37119c__0;
    ...
    VlWide<8>/*255:0*/ __Vdlyvval__tb_dCacheController__DOT__controller_dut__DOT__rdata_block__v0;
    IData/*31:0*/ __VactIterCount;
    VlUnpacked<VlWide<8>/*255:0*/, 256> tb_dCacheController__DOT__controller_dut__DOT__data_store__DOT__mem;
